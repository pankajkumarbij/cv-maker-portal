...
foreach($con->query($data) as $dat)
{
	...
	<div id="resume" style="width: 50%;height: 130vh;background-color: lightgray;margin-bottom:30px;border:1px solid;padding:20px;">
		<div style="width: 100%;height: 20vh;margin-top:10px;background-color:gray;">
			<div style="width: 20%;height: 19vh;float:left;">
				<img src="images/pk.jpg" style="width: 100%;height: 19vh;"/>
			</div>
			<div style="width: 79%;height: 19vh;float:right;">
		<h2 align="left" style="margin-left:50px;color:orange;">
		<?php
		echo $dat['name'];
		?>
	</h2>
  ...
  <hr />
	...
	<div style="width: 100%;height: 35vh;">
		<hr>
		<h2 style="color:orange;">Education Details:</h2>
	...
	<div style="width: 100%;height: 30vh;">
		<hr>
		<h2 style="color:orange;">Work/Internship Experience:</h2>
		<h3 align="left" style="margin-left:50px;">
		<?php
	...
	<div style="width: 100%;height: 30vh;">
		<hr>
		<h2 style="color:orange;">Project Details:</h2>
		<h3 align="left" style="margin-left:50px;">
		<?php
