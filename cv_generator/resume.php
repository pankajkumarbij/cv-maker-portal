...
foreach($con->query($data) as $dat)
{
	...
	<div id="resume" style="width: 50%;height: 130vh;background-color: white;margin-bottom:30px;border:1px solid">
		<div style="width: 20%;height: 130vh;float: left;color:red;">
			<div style="width: 100%;height: 20vh;margin-top:23px;">
				<h3>Personal Info:</h3>
			</div>
		...
		<div style="width: 79.3%;height: 130vh;float: right;">
		<div style="width: 100%;height: 20vh;margin-top:20px;">
		<h3 align="left" style="margin-left:20px;">
		<?php
		echo $dat['name'];
		?>
	</h3>
