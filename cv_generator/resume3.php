...
foreach($con->query($data) as $dat)
{
	...
	<div id="resume" style="width: 50%;height: 130vh;background-color: white;margin-bottom:30px;border:1px solid;padding:20px;">
		<div style="width: 100%;height: 20vh;margin-top:10px;">
			<div style="width: 20%;height: 19vh;float:left;">
				<img src="images/pk.jpg" style="width: 100%;height: 19vh;border-radius: 30%;"/>
			</div>
			<div style="width: 79%;height: 19vh;float:right;">
		<h2 align="left" style="margin-left:50px;color:red;">
		<?php
		echo $dat['name'];
		?>
	</h2>
	...
	<div style="width: 100%;height: 30vh;">
		<hr>
		<h2 style="color:red;">Work/Internship Experience:</h2>
		<h3 align="left" style="margin-left:50px;">
		<?php
	...
	<div style="width: 100%;height: 30vh;">
		<hr>
		<h2 style="color:red;">Project Details:</h2>
		<h3 align="left" style="margin-left:50px;">
		<?php
